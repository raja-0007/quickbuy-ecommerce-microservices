...
// Mock product data - in real app, this would come from params
const MOCK_PRODUCT = {
  id: 1,
  title: 'iPhone 14 Pro',
  brand: 'Apple',
  ...
  price: 999.99,
  stock: 15,
  description: 'Latest iPhone with A16 Bionic chip and ProMotion display',
  image: 'https://cdn.dummyjson.com/product-images/smartphones/iphone-14/1.webp',
  weight: '0.203',
  dimensions: '15.09 x 7.65 x 0.79 cm',
  warranty: '1 Year',
}
...
export default function EditProductPage({ params }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    if (validateForm()) {
      console.log('[v0] Updating product:', formData)
