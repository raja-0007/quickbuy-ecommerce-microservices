...
router.get('/getUserOrders',authMiddleware, controllers.getMyOrders);
...
router.post('/orderConfirmation',authMiddleware, controllers.orderConfirmation);
...
router.delete('/cart/clearCart',authMiddleware, cartControllers.clearCart);
